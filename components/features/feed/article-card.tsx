...
export default function ArticleCard({ article, className }: ArticleCardProps) {
  ...
  const { author: articleAuthor, user: articleUser, title, body, banner, createdAt, _count, id } = article as any;
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col gap-1 min-w-0">
        ...
        <div className="mt-3 flex max-w-md justify-between text-secondary-foreground opacity-60" onClick={(e) => e.stopPropagation()}>
          <Link href={`/articles/${article.id}#comments`} className="group flex items-center gap-2 transition-colors hover:text-primary-ui">
