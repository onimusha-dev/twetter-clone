        ...
        <div className="flex grow flex-col gap-2">
          ...
          {mediaPreview && (
            <div className="relative mt-2 rounded-2xl overflow-hidden border border-border-ui w-fit max-w-full">
               <img src={mediaPreview} alt="Preview" className="max-h-[300px] object-contain bg-secondary-ui/20" />
               <button 
                 onClick={removeMedia}
          ...
          <div className="flex w-full items-center justify-between mt-2 pt-2 border-t">
            <div className="flex items-center gap-1 text-primary-ui">
              ...
              <Link href="/articles/create" className="flex items-center gap-1.5 rounded-full px-3 py-1.5 hover:bg-primary-ui/10 transition-colors font-medium text-sm">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                <span className={cn(
                  "text-xs font-medium",
                  !user?.isVerified && content.length > 500 ? "text-red-500" : "text-secondary-foreground opacity-40"
                )}>
                  {content.length}{!user?.isVerified && " / 500"}
                </span>
