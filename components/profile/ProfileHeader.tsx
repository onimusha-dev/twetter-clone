...
export function ProfileHeader({ name, transmissionCount, isMe }: ProfileHeaderProps) {
  ...
  return (
    <div className="sticky top-0 z-40 bg-background/80 backdrop-blur-md px-4 py-8 flex items-center justify-between border-b border-border/10">
      <div className="flex items-center gap-4 text-left">
        ...
        <div>
          <h1 className="text-xl font-bold tracking-tighter uppercase italic leading-none">{name}</h1>
