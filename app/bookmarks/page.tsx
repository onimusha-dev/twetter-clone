    ...
    <MainLayout>
      ...
      {isLoading ? (
        ...
        <div className="flex flex-col items-center justify-center h-64 p-8 text-center">
          ...
          <p className="text-secondary-foreground opacity-60">Failed to load bookmarks. Please try again later.</p>
        </div>
      ) : bookmarks.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center h-[60vh] p-8 text-center max-w-sm mx-auto">
          ...
          <p className="text-secondary-foreground opacity-60">
            Don&apos;t let the good stuff slip away! Bookmark posts and articles to easily find them again in the future.
          </p>
        </div>
      )}
    </MainLayout>
