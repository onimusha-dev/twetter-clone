...
export const useCreateArticle = () => {
  ...
  return useMutation({
    mutationFn: async (data: { title: string, body: string, published?: boolean, banner?: File, enableComments?: boolean }) => {
...
export const useUpdateArticle = () => {
  ...
  return useMutation({
    mutationFn: async ({ articleId, title, body, published, banner }: { 
      articleId: number, 
      title?: string, 
      body?: string, 
      published?: boolean,
